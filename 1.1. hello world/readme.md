...
<div style="background-color:#d4f7d4; padding:12px; border-left: 5px solid #4CAF50; border-radius:6px;">

✅ <b>Задание для самостоятельной реализации:</b><br>
Сравните приведенный пример с первой программой <code>Hello World</code> и добавьте вывод сообщений в консоль на каждой итерации цикла, сообщающих текущее состояние светодиода.
