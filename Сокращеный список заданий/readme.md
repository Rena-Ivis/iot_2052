# Курс
https://lms.ulstu.ru/course/view.php?id=2762 для доступа в качестве ключевого слова ввести ВТАСбз-31

В данном курсе в разделе материалы есть лекции и рекомендации к оформлению отчетов

Также все отчеты будуь приниматься там в разделе Отчеты по сокращенному списку л/р (отправлять только туда, не трогать соседний раздел)
